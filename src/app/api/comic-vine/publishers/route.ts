...
export async function GET(request: NextRequest) {
	...
	let apiUrl;
	if (searchTerm) {
	  apiUrl = `https://comicvine.gamespot.com/api/search/?api_key=${apiKey}&format=json&sort=name:asc&resources=publisher&query=${encodeURIComponent(searchTerm)}&limit=${limit}&page=${page}`;
	} else {
